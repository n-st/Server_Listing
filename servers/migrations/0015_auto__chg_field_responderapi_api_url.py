...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ResponderAPI.api_url'
        db.alter_column(u'servers_responderapi', 'api_url', self.gf('django.db.models.fields.GenericIPAddressField')(max_length=39))

    def backwards(self, orm):

        # Changing field 'ResponderAPI.api_url'
        db.alter_column(u'servers_responderapi', 'api_url', self.gf('django.db.models.fields.CharField')(max_length=255))
