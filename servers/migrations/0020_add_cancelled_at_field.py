...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.add_column(u'servers_server', 'cancelled_at', self.gf('django.db.models.fields.DateField')(null=True, blank=True))

    def backwards(self, orm):
        db.delete_column(u'servers_server', 'cancelled_at')
    ...
    models = {
        ...
        u'servers.server': {
            ...
            'billed_at': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            'billed_automatically': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'cancelled_at': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
