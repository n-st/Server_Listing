...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SolusAPI'
        db.create_table(u'servers_solusapi', (
            ...
            ('api_hash', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated_at', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'servers', ['SolusAPI'])
    ...
    def backwards(self, orm):
        # Deleting model 'SolusAPI'
        db.delete_table(u'servers_solusapi')
    ...
    models = {
        ...
        u'servers.server': {
            ...
            'solus_api': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['servers.SolusAPI']", 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
