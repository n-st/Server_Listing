...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ServerCheck.did_change'
        db.delete_column(u'servers_servercheck', 'did_change')


    def backwards(self, orm):
        # Adding field 'ServerCheck.did_change'
        db.add_column(u'servers_servercheck', 'did_change',
