...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ResponderAPI.auth_key'
        db.delete_column(u'servers_responderapi', 'auth_key')

        # Deleting field 'ResponderAPI.url'
        db.delete_column(u'servers_responderapi', 'url')

        # Deleting field 'ResponderAPI.port'
        db.delete_column(u'servers_responderapi', 'port')

        # Adding field 'ResponderAPI.api_key'
        db.add_column(u'servers_responderapi', 'api_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'ResponderAPI.api_port'
        db.add_column(u'servers_responderapi', 'api_port',
                      self.gf('django.db.models.fields.IntegerField')(default=8080, max_length=8),
                      keep_default=False)

        # Adding field 'ResponderAPI.api_url'
        db.add_column(u'servers_responderapi', 'api_url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ResponderAPI.auth_key'
        db.add_column(u'servers_responderapi', 'auth_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'ResponderAPI.url'
        db.add_column(u'servers_responderapi', 'url',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Adding field 'ResponderAPI.port'
        db.add_column(u'servers_responderapi', 'port',
                      self.gf('django.db.models.fields.IntegerField')(default=8080, max_length=8),
                      keep_default=False)

        # Deleting field 'ResponderAPI.api_key'
        db.delete_column(u'servers_responderapi', 'api_key')

        # Deleting field 'ResponderAPI.api_port'
        db.delete_column(u'servers_responderapi', 'api_port')

        # Deleting field 'ResponderAPI.api_url'
        db.delete_column(u'servers_responderapi', 'api_url')
    ...
    models = {
        ...
        u'servers.responderapi': {
            ...
            'api_url': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
