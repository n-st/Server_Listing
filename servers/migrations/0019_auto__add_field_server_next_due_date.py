...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Server.next_due_date'
        db.add_column(u'servers_server', 'next_due_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Server.next_due_date'
        db.delete_column(u'servers_server', 'next_due_date')
    ...
    models = {
        ...
        u'servers.server': {
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'next_due_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
